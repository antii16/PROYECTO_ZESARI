...
<main>
    ...
    <div class="main-contenido">
        ...
        <div class="crear"> 
            ...
            <form id="formularioCrear" action="<?=$_ENV['base_url']?>blog/editar/<?=$blog->id?>" method="POST" enctype="multipart/form-data">
                <div class="contenedor">
                    ...
                    <div class="caja">
                        <p> 
                            ...
                            <textarea  name="data[texto]" id="contenido" cols="30" rows="10" required><?php echo $blog->texto; ?>
                            </textarea>
